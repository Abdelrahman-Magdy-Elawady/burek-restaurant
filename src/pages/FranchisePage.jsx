          ...
          <div className="mb-16">
            <div className="mb-16 flex flex-col items-center gap-12 ">
              ...
              <div className="px-8 flex flex-col items-center gap-16 text-pretty">
                <div>
                  Our history began in 2018 with the first institution in Lviv
                  as a grand plan to reform people’s thinking about food
                  culture. At this time, we have already opened 17 cozy
                  locations in different parts of Lviv and are open to the
                  expansion of our chain through franchise agreements.
                </div>
                <Button
                  styles={{
                    button:
                      "rounded-sm py-3 w-full uppercase font-bold max-w-60",
                    bg: "bg-primary",
                    text: "text-secondary",
            ...
            {[
              ...
              >
                ...
                <div
                  ...
                  style={{
                    backgroundImage:
                      "linear-gradient(90deg,orange,white,orange)",
